...
/**
 * Created by Sangram on 21/3/15.
 */
public class myIEEE extends FrameLayout {

        private final FrameLayout mRootView;
        ProgressBar progressBar;
        public myIEEE(Context context) {
            this(context, null);
        }

        public myIEEE(Context context, AttributeSet attrs) {
            this(context, attrs, 0);
        }

        public myIEEE(Context context, AttributeSet attrs, int defStyle) {
