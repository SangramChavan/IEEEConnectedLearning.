 ...
 */
public class Publish extends FrameLayout {
    ...
    public Publish(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Publish(Context context, AttributeSet attrs, int defStyle) {
