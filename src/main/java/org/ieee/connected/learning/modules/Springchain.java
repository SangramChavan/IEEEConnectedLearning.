...
import org.ieee.connected.SimpleSpringListener;
import org.ieee.connected.Spring;
import org.ieee.connected.SpringChain;
import org.ieee.connected.learning.R;

import java.util.ArrayList;
import java.util.List;

public class Springchain extends FrameLayout {
    ...
    public Springchain(Context context) {
        super(context);

        LayoutInflater inflater = LayoutInflater.from(context);
        ViewGroup container = (ViewGroup) inflater.inflate(R.layout.cascade_effect, this, false);
        addView(container);
        ViewGroup contain = (ViewGroup) inflater.inflate(R.layout.mission, this, false);
        addView(contain);
